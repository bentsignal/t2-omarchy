...
GOOD = "\n".join((
    ...
    line("ACM context-create request: endpoint=10 message_type=1 selector=36 length=12 subject_uid=0 expected_reply=21"),
...
class VerifyAcmContextLifecycleLogTests(unittest.TestCase):
    ...
    def test_accepts_exact_apple_minus_three_fallback(self):
        fallback = GOOD.replace(
            ...
            line("ACM context-create fallback request: endpoint=10 message_type=1 selector=1 length=12 subject_uid=0 expected_reply=17") + "\n" +
