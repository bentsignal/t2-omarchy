...
ORDERED = (
    ...
    "AKS unload-keybag reply passed strict validation",
    "AKS copy-keybag confirms teardown: status=-3 absent=yes",
    "ACM context-delete reply passed strict validation",
    "ephemeral keybag authorization completed: created=yes authorized=yes unload=0 absent_proof=0 context_delete=0",
