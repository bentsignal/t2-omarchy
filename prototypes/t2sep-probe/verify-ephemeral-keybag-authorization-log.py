...
ORDERED = (
    ...
    "AKS unload-keybag reply passed strict validation: role=source",
    "AKS copy-keybag confirms teardown: role=source",
    "ACM context-delete reply passed strict validation",
    "ephemeral keybag authorization completed: created=yes promoted=yes promote=0 authorized=yes system_unload=0 system_absent_proof=0 source_unload=0 source_absent_proof=0 context_delete=0",
